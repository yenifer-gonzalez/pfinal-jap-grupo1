        ...
        html += `
            <div class="product-card" data-product-id="${producto.id}" onclick="goToProduct(${producto.id})">
                <div class="product-image">
                    ...
                    <button class="favorite-btn" onclick="toggleFavorite(event, ${producto.id})">♡</button>
                </div>
...
function setupFilters() {
    ...
    if (brandFilter) brandFilter.addEventListener('change', debouncedApplyFilters);
    if (modelFilter) modelFilter.addEventListener('change', debouncedApplyFilters);
    if (priceFilter) priceFilter.addEventListener('change', debouncedApplyFilters);
    if (kilometersFilter) kilometersFilter.addEventListener('change', debouncedApplyFilters);
